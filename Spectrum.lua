...
local SCRIPT_FILE_ADDR = "https://raw.githubusercontent.com/RKS-GOD/Spectrum.lua/main/Spectrum.lua";
local VERSION_FILE_ADDR = "https://raw.githubusercontent.com/RKS-GOD/Spectrum.lua/main/version.txt";
